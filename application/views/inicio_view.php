        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                <div class="skill-wrap">
                    ...
                    <p class="skill-desc">Amante del diseño, el maquetado Web y las buenas prácticas de programación.</p>
            ...
            <div class="col-md-3 col-sm-6">
                <div class="skill-wrap">
                    ...
                    <ul class="fa-ul">
                        ...
                        <li><i class="fa-fw fa-li fa fa-angle-double-right"></i>Estándares Web (W3C)</li>
    ...
    <div class="container">
        ...
        <ul class="timeline">
            ...
            <li class="present">
                <div class="tl-header">
                    <h3 class="tl-role">Diseño & Desarrollo</h3>
                    <h4 class="tl-company"><a href="http://www.optilodging.com/entrar" target="_blank">http://www.optilodging.com/</a></h4>
            ...
            <li class="present right">
                <div class="tl-header">
                    <h3 class="tl-role">Diseño</h3>
                    <h4 class="tl-company"><a href="http://www.optilodging.com/" target="_blank">http://www.optilodging.com/</a></h4>
            ...
            <li class="present">
                <div class="tl-header">
                    <h3 class="tl-role">Diseño & Desarrollo</h3>
                    <h4 class="tl-company"><a href="http://froac.manizales.unal.edu.co/roap/" target="_blank" >http://froac.manizales.unal.edu.co/roap/</a></h4>
